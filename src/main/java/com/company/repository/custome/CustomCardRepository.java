...
//
//        if (dto.getId() != null) {
//            builder.append(" and a.id = '").append(dto.getId()).append("' ");
//        }
//
//        if (dto.getTitle() != null) {
//            builder.append(" and a.title = '" + dto.getTitle() + "' ");
//        }
//        // Select a from CardEntity a where title = 'asdasd'; delete from sms-- fdsdfsdfs'
...
//        List<CardEntity> articleList = query.getResultList();
//
//        return articleList;
//    }
//
